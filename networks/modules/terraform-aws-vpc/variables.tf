...
variable "kafka_subnet_names" {
  description = "Explicit values to use in the Name tag on kafka subnets. If empty, Name tags are generated."
  type        = list(string)
  default     = []
}
...
variable "kafka_subnets" {
  description = "A list of kafka subnets"
  type        = list(string)
  default     = []
}
...
variable "create_kafka_subnet_route_table" {
  description = "Controls if separate route table for kafka should be created"
  type        = bool
  default     = false
}
...
variable "create_kafka_subnet_group" {
  description = "Controls if kafka subnet group should be created"
  type        = bool
  default     = true
}
...
variable "kafka_subnet_group_name" {
  description = "Name of kafka subnet group"
  type        = string
  default     = null
}

variable "kafka_subnet_group_tags" {
  description = "Additional tags for the kafka subnet group"
  type        = map(string)
  default     = {}
}
...
variable "kafka_acl_tags" {
  description = "Additional tags for the kafka subnets network ACL"
  type        = map(string)
  default     = {}
}
...
variable "kafka_inbound_acl_rules" {
  description = "Kafka subnets inbound network ACL rules"
  type        = list(map(string))
...
variable "kafka_outbound_acl_rules" {
  description = "Kafka subnets outbound network ACL rules"
  type        = list(map(string))
